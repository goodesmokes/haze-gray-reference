...
import { OrderBuilder } from "./js/components/order-builder.mjs";
import { CatalogEditor } from "./js/components/catalog-editor.mjs";
import { DetailOrderControls } from "./js/components/detail-order-controls.mjs";
  ...
  return (
    <div style={{
      ...
      {formOpen && canEditCatalog && canEditPackages && (
        <CatalogEditor form={form} editingId={editingId} uploading={uploading} uploadError={uploadError} fileInputRef={fileInputRef} onClose={() => setFormOpen(false)} onFormChange={setForm} onPhotoFile={handlePhotoFile} onSetSizeField={setSizeField} onAddSize={addSizeRow} onRemoveSize={removeSizeRow} onSave={saveForm} />
      )}
